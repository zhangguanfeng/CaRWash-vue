  ...
  <div>
    <el-card class="container">
      ...
      <el-card class="search_card" shadow="hover">
        ...
        <div class="search_card_bottom">
          <el-input placeholder="请输入姓名" class="searchByName" clearable v-model="searchByName">
          </el-input>
          <el-input placeholder="请输入代理店" class="searchByShop" clearable v-model="searchByShop">
          </el-input>
          <el-button class="search" round>搜索</el-button>
        </div>
      </el-card>
      ...
      <el-table :data="tableData" border style="width: 100%">
        <el-table-column prop="staffName" label="姓名" width="250">
        </el-table-column>
        <el-table-column prop="shop" label="代理店" width="250">
        </el-table-column>
    ...
    <el-dialog title="添加职员" :visible.sync="dialogFormVisible">
      <el-form ref="addStaffForm" :model="addStaffForm" label-width="90px" label-position="left"
        ...
        <el-form-item label="代理店：">
          <el-col :span="10">
            <el-select v-model="addStaffForm.shop" placeholder="请选择代理店">
      ...
      <el-button type="primary" style="margin-left:30px;">添加</el-button>
    </el-dialog>
  </div>
</template>
